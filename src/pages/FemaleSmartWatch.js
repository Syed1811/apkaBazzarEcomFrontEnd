    ...
    const fetchProductsByCategory = async () => {
      try {
        const response = await axios.get(
          `https://e-comm-2uyq.onrender.com/api/v1/product//products-by-category/female-smart-watches`
        );
              ...
              <div className="price-sort mt-4 mb-4 me-auto">
                ...
                <div className="d-flex flex-row">
                  ...
                  <div
                    ...
                    onClick={() => {
                      color === "pink" ? setColor("") : setColor("pink");
                    }}
                  ></div>
                  <div
                    className="w-10 me-1"
...
export default FemaleSmartWatch;
