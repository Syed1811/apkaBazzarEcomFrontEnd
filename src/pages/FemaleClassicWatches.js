    ...
    const fetchProductsByCategory = async () => {
      try {
        const response = await axios.get(
          `https://e-comm-2uyq.onrender.com/api/v1/product//products-by-category/female-classic-watches`
        );
...
export default FemaleClassicWatches;
